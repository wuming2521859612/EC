...
public interface IAddressMapper {
	 ...
	 * @return
	 */
	@Insert("insert into address values(seq_address.nextval,userid=#{userid},addname=#{addname},addphone=#{addphone},addmobile=#{addmobile},addprovince=#{addprovince},addcity=#{addcity},adddistict=#{adddistict},addaddress=#{addaddress},addzip=#{addzip},addcreatetime=#{addcreatetime},addlasttime=#{addlasttime})")
