...
public interface IOrderinfoDAO {
	 ...
	 * @return
	 */
	@Insert("insert into orderinfo values(seq_orderinfo.nextval,#{payorder},#{userid},#{proid},#{payment},#{paymenttype},#{paypostage},#{paystatus},#{paymenttime},#{paysendtime},#{payendtime},#{payclosetime},#{paycreatetime},#{paylasttime})")
