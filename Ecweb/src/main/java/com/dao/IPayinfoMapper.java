...
public interface IPayinfoMapper {
	 ...
	 * @return
	 */
	@Insert("insert into payinfo values(seq_payinfo.nextval,payorder=#{payorder},payplatform=#{payplatform},platformnumber=#{platformnumber},platformstatus=#{platformstatus},paytime=#{paytime},paylasttime=#{paylasttime})")
